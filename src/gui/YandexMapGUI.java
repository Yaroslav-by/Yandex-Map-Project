...
public class YandexMapGUI extends JFrame {
	...
	public YandexMapGUI() {
		...
		JRadioButton radioButtonScheme = new JRadioButton("�����");
		JRadioButton radioButtonSatellite = new JRadioButton("�������");
		JCheckBox checkButtonTraffic = new JCheckBox("������");
		...
		JLabel labelMapName = new JLabel("�����");
